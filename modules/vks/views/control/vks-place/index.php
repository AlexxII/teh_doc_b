  ...
  <div class="fancytree-control-panel">
    <div class="container-fluid" style="margin-bottom: 10px">
      ...
      <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['#'], ['class' => 'btn btn-danger btn-sm del-node',
        ...
        'data-placement' => 'top',
        'data-tree' => 'fancyree_vks_place',
        'data-delete' => '/vks/control/vks-place/delete'
      ]) ?>
  ...
  <div class="col-lg-12 col-md-12" style="padding-bottom: 10px">
    <div style="position: relative">
      ...
      <div style="padding-top: 8px; right: 10px; position: absolute">
        <a href="" class="btnResetSearch" data-tree="fancyree_vks_place">
    ...
    <div class="row" style="padding: 0 15px">
      <div style="border-radius:2px;padding-top:40px">
        <div id="fancyree_vks_place" class="ui-draggable-handle"></div>
      </div>
    </div>
  </div>
