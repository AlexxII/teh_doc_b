...
function Answer(config) {
  ...
  this.renderUniqueSymbl = function () {
    ...
    this.uniqueSymbl = uniqueNode;
  };

  this.renderFreeSymbl = function () {
  ...
  this.renderAnswer = function (index) {
    ...
    if (this.type === TYPE_FREE_ANSWER) {
      answerTemplate.appendChild(this.freeSymbl);
    }
    if (this.unique === 1) {
      answerTemplate.appendChild(this.uniqueSymbl);
    }
