...
<script>
  ...
  $(document).ready(function () {
    $('.add-subcategory').click(function (event) {
      ...
      var root = tree.findFirst('Дежурства');
  ...
  jQuery(function ($) {
    var main_url = '/scheduler/control/duty-type/all-types';
    var move_url = '/scheduler/control/duty-type/move-node';
    var create_url = '/scheduler/control/duty-type/create-node';
    var update_url = '/scheduler/control/duty-type/update-node';
