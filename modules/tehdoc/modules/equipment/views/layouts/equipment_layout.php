    ...
    'items' => [
      [
        ...
        'items' => [
          ...
          ['label' => 'Все средства', 'url' => ['/tehdoc/equipment/tools/tools/index']],
          '<li class="divider"></li>',
      ...
      */
      [
        ...
        'items' => [
          ...
          ['label' => 'По категориям', 'url' => ['/tehdoc/equipment/tools/tools/categories']],
          ['label' => 'По месту размещения', 'url' => ['/tehdoc/equipment/tools/tools/placement']],
//                    '<li class="divider"></li>',
