...
(function($) {
  ...
  Calendar.prototype = {
    ...
    _initializeEvents: function(opt) {
      ...
      if(opt.clickMonth) { this.element.bind('clickMonth', opt.clickMonth); }
    ...
    _applyEvents: function () {
      ...
      var mCells = this.element.find('.month-title:not(.old, .new, .disabled)');

      /* Click on month */
      mCells.click(function(e) {
        e.stopPropagation();
        var date = _this._getDateEx($(this));
        _this._triggerEvent('clickMonth', {
          event: e,
          element: $(this),
          which: e.which,
          date: date,
  ...
  $.fn.clickMonth = function(fct) { $(this).bind('clickMonth', fct); }
