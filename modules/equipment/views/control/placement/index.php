...
$about = "Панель управления местами размещения оборудования.";
...
<div class="admin-placement-pannel">
  ...
  <div class="col-lg-12 col-md-12 search" style="padding-bottom: 10px">
    <div class="">
      <div style="position: relative">
        ...
        <div style="padding-top: 8px; right: 10px; position: absolute">
          <a href="" class="btnResetSearch"><i class="fa fa-times-circle" aria-hidden="true"
    ...
    <div class="row" style="padding: 0 15px">
      <div class="" style="border-radius:2px;padding-top:40px">
        <div id="fancyree_placement" class="ui-draggable-handle"></div>
      </div>
    </div>
  </div>
...
<script>
  $(document).ready(function () {
    ...
    $('.add-subcategory').click(function (event) {
      ...
      var node = $("#fancyree_placement").fancytree("getActiveNode");
      if (!node) {
    ...
    $('.refresh').click(function (event) {
      event.preventDefault();
      var tree = $("#fancyree_placement").fancytree("getTree");
      tree.reload();
      $(".del-node").hide();
    ...
    $('.del-node').click(function (event) {
      var url = '/equipment/control/placement/delete';
      event.preventDefault();
      jc = $.confirm({
        icon: 'fa fa-question',
        title: 'Вы уверены?',
    ...
    $('.del-multi-nodes').click(function (event) {
      var url = '/equipment/control/placement/delete-root';
      event.preventDefault();
      jc = $.confirm({
        icon: 'fa fa-question',
        title: 'Вы уверены?',
  ...
  $("input[name=search]").keyup(function (e) {
    var n,
      tree = $("#fancyree_placement").fancytree("getTree"),
