  ...
  <div class="fancytree-control-panel">
    <div class="container-fluid" style="margin-bottom: 10px">
      ...
      <?= Html::a('<i class="fa fa-trash" aria-hidden="true"></i>', ['#'], ['class' => 'btn btn-danger btn-sm del-node',
        ...
        'data-placement' => 'top',
        'data-tree' => 'fancytree_placement',
        'data-delete' => '/equipment/control/placement/delete'
      ]) ?>
      <?= Html::a('<i class="fa fa-object-group" aria-hidden="true"></i>', ['#'], ['class' => 'btn btn-danger btn-sm del-multi-nodes',
        ...
        'data-placement' => 'top',
        'data-tree' => 'fancytree_placement',
        'data-delete' => '/equipment/control/placement/delete-root'
      ]) ?>
    </div>
  ...
  <div class="col-lg-12 col-md-12 search" style="padding-bottom: 10px">
    <div class="">
      <div style="position: relative">
        ...
        <div style="padding-top: 8px; right: 10px; position: absolute">
          <a href="" class="btnResetSearch" data-tree="fancytree_placement">
    ...
    <div class="row" style="padding: 0 15px">
      <div class="" style="border-radius:2px;padding-top:40px">
        <div id="fancytree_placement" class="ui-draggable-handle"></div>
      </div>
    </div>
  </div>
